...
#define KACF_ENABLE_PROCESS_SYSTEMDPIAWARENESS \
    0x20000000000000 // rev // Enable Per-Process System DPI Awareness and Opt-in to Per-Process System DPI mode.
#define KACF_DISABLE_PROCESS_SYSTEMDPIAWARENESS \
    0x40000000000000 // rev // Disable Per-Process System DPI Awareness and force legacy DPI behavior.
...
typedef struct _PEB
{
    ...
    union
    {
        ...
        struct
        {
            ...
            BOOLEAN SkipPatchingUser32Forwarders : 1; // The process skipped forwarders for User32.dll functions. 1 for
                                                      // 64-bit, 0 for 32-bit.
...
{
    //
    // Thread Information Block (TIB) contains the thread's stack, base and limit addresses, the current stack pointer,
