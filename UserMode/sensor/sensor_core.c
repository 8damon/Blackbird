#include "core/sensor_core_internal.h"

#pragma comment(lib, "advapi32.lib")
#pragma comment(lib, "tdh.lib")

BKSC_API const GUID BKSC_PROVIDER_GUID_BLACKBIRD = {
    0xd6c73f8a, 0x6ad8, 0x4f4b, {0xa3, 0x63, 0x3d, 0x2f, 0xa3, 0x1c, 0xd0, 0xe2}};
BKSC_API const GUID BKSC_PROVIDER_GUID_TI = {
    0xf4e1897c, 0xbb5d, 0x5668, {0xf1, 0xd8, 0x04, 0x0f, 0x4d, 0x8d, 0xd3, 0x44}};
BKSC_API const GUID BKSC_PROVIDER_GUID_KERNEL_NETWORK = {
    0x7dd42a49, 0x5329, 0x4832, {0x8d, 0xfd, 0x43, 0xd9, 0x79, 0x15, 0x3a, 0x88}};

volatile LONG g_BlackbirdProtocolMode = BKSC_PROTOCOL_SERVICE;
WCHAR g_BlackbirdPipeName[MAX_PATH] = BKIPC_PIPE_NAME;
