                                                            ...
                                                            _Out_opt_ PULONG ReturnLength)
{
    ...
    if (g_OriginalNtQuerySystemInformation == NULL)
    {
        BLACKBIRD_NTAPI_LOG(DPFLTR_ERROR_LEVEL,
                            "BLACKBIRD: ntapi hook original null api=NtQuerySystemInformation.\n");
    ...
    BLACKBIRDEtwLogSystemInfoEvent(callerPid, PsGetCurrentThreadId(), SystemInformationClass, SystemInformationLength,
                                   observedReturnLength, status);
    BLACKBIRDNtApiLog("NtQuerySystemInformation", callerPid, (UINT64)SystemInformationClass,
                      (UINT64)SystemInformationLength, (UINT64)observedReturnLength, 0, 0, 0, 0, 0, status);
                                                             ...
                                                             _Out_opt_ PULONG ReturnLength)
{
    ...
    {
        BLACKBIRD_NTAPI_LOG(DPFLTR_ERROR_LEVEL,
                            "BLACKBIRD: ntapi hook original null api=NtQueryInformationProcess.\n");
        status = STATUS_INVALID_DEVICE_STATE;
        goto Exit;
    }
    ...
    observedReturnLength = BLACKBIRDNtApiReadUlongSafe(ReturnLength);
    BLACKBIRDNtApiLog("NtQueryInformationProcess", callerPid, (UINT64)(ULONG_PTR)ProcessHandle,
                      (UINT64)ProcessInformationClass, (UINT64)(ULONG_PTR)ProcessInformation,
                      (UINT64)ProcessInformationLength, (UINT64)observedReturnLength, 0, 0, 0, status);
                                                        ...
                                                        _Out_opt_ PSIZE_T NumberOfBytesWritten)
{
    ...
    {
        BLACKBIRD_NTAPI_LOG(DPFLTR_ERROR_LEVEL,
                            "BLACKBIRD: ntapi hook original null api=NtWriteVirtualMemory.\n");
        status = STATUS_INVALID_DEVICE_STATE;
        goto Exit;
    }
    ...
    BLACKBIRDNtApiLog("NtWriteVirtualMemory", callerPid, (UINT64)(ULONG_PTR)ProcessHandle, (UINT64)(ULONG_PTR)BaseAddress,
                      (UINT64)(ULONG_PTR)Buffer, (UINT64)BufferSize, (UINT64)observedWritten, 0, 0, 0, status);
                                                          ...
                                                          _Out_ PULONG OldProtect)
{
    ...
    {
        BLACKBIRD_NTAPI_LOG(DPFLTR_ERROR_LEVEL,
                            "BLACKBIRD: ntapi hook original null api=NtProtectVirtualMemory.\n");
        status = STATUS_INVALID_DEVICE_STATE;
        goto Exit;
    }
    ...
    BLACKBIRDNtApiLog("NtProtectVirtualMemory", callerPid, (UINT64)(ULONG_PTR)ProcessHandle,
                      (UINT64)(ULONG_PTR)observedBase, (UINT64)observedSize, (UINT64)NewProtect,
                      (UINT64)observedOldProtect, 0, 0, 0, status);
                                                   ...
                                                   _In_opt_ HANDLE FileHandle)
{
    ...
    BLACKBIRDNtApiLog("NtCreateSection", callerPid, (UINT64)(ULONG_PTR)observedSectionHandle, (UINT64)DesiredAccess,
                      observedMaximumSize, (UINT64)SectionPageProtection, (UINT64)AllocationAttributes,
                      (UINT64)(ULONG_PTR)FileHandle, (UINT64)(ULONG_PTR)ObjectAttributes, 0, status);
                                                      ...
                                                      _In_ ULONG AllocationType, _In_ ULONG Win32Protect)
{
    ...
    BLACKBIRDNtApiLog("NtMapViewOfSection", callerPid, (UINT64)(ULONG_PTR)SectionHandle,
                      (UINT64)(ULONG_PTR)ProcessHandle, (UINT64)(ULONG_PTR)observedBase, (UINT64)observedViewSize,
                      (UINT64)InheritDisposition, (UINT64)AllocationType, (UINT64)Win32Protect, observedOffset, status);
                                                              ...
                                                              _Out_opt_ PULONG ReturnLength)
{
    ...
    BLACKBIRDEtwLogSystemInfoEvent(callerPid, PsGetCurrentThreadId(), SystemInformationClass, SystemInformationLength,
                                   observedReturnLength, status);
    BLACKBIRDNtApiLog("NtQuerySystemInformationEx", callerPid, (UINT64)SystemInformationClass,
                      (UINT64)(ULONG_PTR)InputBuffer, (UINT64)InputBufferLength, (UINT64)(ULONG_PTR)SystemInformation,
                      (UINT64)SystemInformationLength, (UINT64)observedReturnLength, 0, 0, status);
                                                     ...
                                                     _In_ ULONG ExtendedParameterCount)
{
    ...
    if (g_OriginalNtCreateSectionEx == NULL)
    {
        BLACKBIRD_NTAPI_LOG(DPFLTR_ERROR_LEVEL, "BLACKBIRD: ntapi hook original null api=NtCreateSectionEx.\n");
        status = STATUS_INVALID_DEVICE_STATE;
        goto Exit;
    }
    status = g_OriginalNtCreateSectionEx(SectionHandle, DesiredAccess, ObjectAttributes, MaximumSize,
                                         SectionPageProtection, AllocationAttributes, FileHandle, ExtendedParameters,
    ...
    observedSectionHandle = BLACKBIRDNtApiReadHandleSafe(SectionHandle);
    observedMaximumSize = BLACKBIRDNtApiReadLargeIntegerSafe(MaximumSize);
    BLACKBIRDNtApiLog("NtCreateSectionEx", callerPid, (UINT64)(ULONG_PTR)observedSectionHandle, (UINT64)DesiredAccess,
                      observedMaximumSize, (UINT64)SectionPageProtection, (UINT64)AllocationAttributes,
                      (UINT64)(ULONG_PTR)FileHandle, (UINT64)(ULONG_PTR)ExtendedParameters, (UINT64)ExtendedParameterCount,
                      status);
    ...
    _In_ ULONG ExtendedParameterCount)
{
    ...
    {
        BLACKBIRD_NTAPI_LOG(DPFLTR_ERROR_LEVEL, "BLACKBIRD: ntapi hook original null api=NtMapViewOfSectionEx.\n");
        status = STATUS_INVALID_DEVICE_STATE;
        goto Exit;
    }
    ...
    observedViewSize = BLACKBIRDNtApiReadSizeTSafe(ViewSize);
    observedOffset = BLACKBIRDNtApiReadLargeIntegerSafe(SectionOffset);
    BLACKBIRDNtApiLog("NtMapViewOfSectionEx", callerPid, (UINT64)(ULONG_PTR)SectionHandle,
                      (UINT64)(ULONG_PTR)ProcessHandle, (UINT64)(ULONG_PTR)observedBase, (UINT64)observedViewSize,
                      (UINT64)AllocationType, (UINT64)Win32Protect, observedOffset, (UINT64)ExtendedParameterCount, status);
    ...
    _In_ ULONG ExtendedParameterCount)
{
    ...
    if (g_OriginalNtAllocateVirtualMemoryEx == NULL)
    {
        BLACKBIRD_NTAPI_LOG(DPFLTR_ERROR_LEVEL,
                            "BLACKBIRD: ntapi hook original null api=NtAllocateVirtualMemoryEx.\n");
        status = STATUS_INVALID_DEVICE_STATE;
        goto Exit;
    }
    status = g_OriginalNtAllocateVirtualMemoryEx(ProcessHandle, BaseAddress, RegionSize, AllocationType, Protect,
    ...
    BLACKBIRDNtApiLog("NtAllocateVirtualMemoryEx", callerPid, (UINT64)(ULONG_PTR)ProcessHandle,
                      (UINT64)(ULONG_PTR)observedBase, (UINT64)observedRegionSize, (UINT64)AllocationType,
                      (UINT64)Protect, (UINT64)(ULONG_PTR)ExtendedParameters, (UINT64)ExtendedParameterCount, 0, status);
                                                      ...
                                                      _In_ ULONG AllocationType, _In_ ULONG Protect)
{
    ...
    if (remainingBudget >= 0)
    {
        BLACKBIRD_NTAPI_LOG(DPFLTR_INFO_LEVEL,
                            "BLACKBIRD: ntapi allocate prelog original=%p process=%p basePtr=%p zeroBits=0x%p regionPtr=%p allocType=0x%08X protect=0x%08X.\n",
    ...
    observedBase = BLACKBIRDNtApiReadPointerSafe(BaseAddress);
    observedRegionSize = BLACKBIRDNtApiReadSizeTSafe(RegionSize);
    BLACKBIRDNtApiLog("NtAllocateVirtualMemory", callerPid, (UINT64)(ULONG_PTR)ProcessHandle,
                      (UINT64)(ULONG_PTR)observedBase, (UINT64)observedRegionSize, (UINT64)ZeroBits,
                      (UINT64)AllocationType, (UINT64)Protect, 0, 0, STATUS_SUCCESS);
