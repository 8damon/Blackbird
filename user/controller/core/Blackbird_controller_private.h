...
#define BLACKBIRD_CONTROLLER_SHARED_IOCTL_RING_CAPACITY 16384u
#define BLACKBIRD_CONTROLLER_SHARED_ETW_RING_CAPACITY 4096u
...
#define BLACKBIRD_CONTROLLER_HOOK_READY_REQUIRED_MASK BLACKBIRD_IPC_HOOK_READY_FLAG_IPC_CONNECTED
