...
extern "C"
{
    ...
    typedef VOID(WINAPI *BLACKBIRDSC_ETW_EVENT_CALLBACK)(_In_ PEVENT_RECORD Record,
    ...
    BLACKBIRDSC_API BOOL BLACKBIRDSCSetPids(_In_ HANDLE Device,
    ...
    BLACKBIRDSC_API BOOL BLACKBIRDSCGetEvent(_In_ HANDLE Device,
                                             _Out_ BLACKBIRD_EVENT_RECORD *Record,
                                             _Out_opt_ DWORD *BytesReturned);
    BLACKBIRDSC_API BOOL BLACKBIRDSCGetStats(_In_ HANDLE Device,
                                             _Out_ BLACKBIRD_STATS_RESPONSE *Stats,
                                             _Out_opt_ DWORD *BytesReturned);
    BLACKBIRDSC_API BOOL BLACKBIRDSCGetHealth(_In_ HANDLE Device,
                                              _Out_ BLACKBIRD_HEALTH_RESPONSE *Health,
                                              _Out_opt_ DWORD *BytesReturned);
    BLACKBIRDSC_API BOOL BLACKBIRDSCQueryProcessImagePath(_In_ HANDLE Device,
                                                          _In_ DWORD ProcessId,
                                                          _Out_writes_z_(OutputChars) PWSTR Output,
                                                          _In_ DWORD OutputChars);
    BLACKBIRDSC_API BOOL BLACKBIRDSCSetUserHookTarget(_In_ HANDLE Device,
                                                      _In_ DWORD Mode,
                                                      _In_ DWORD ProcessId,
                                                      _In_ DWORD Flags,
    ...
    BLACKBIRDSC_API BOOL BLACKBIRDSCGetEtwEvent(_In_ HANDLE Device,
    ...
    BLACKBIRDSC_API BOOL BLACKBIRDSCStartBlackbirdEtwSession(_In_z_ PCWSTR SessionName,
                                                             _In_ BOOL EnableThreatIntelProvider,
                                                             _In_ BLACKBIRDSC_ETW_EVENT_CALLBACK Callback,
                                                             _In_opt_ PVOID CallbackContext,
                                                             _Outptr_ BLACKBIRDSC_ETW_SESSION **Session,
                                                             _Out_opt_ BOOL *ThreatIntelEnabled);
    BLACKBIRDSC_API BOOL SwkStartDetectionEtwSession(_In_z_ PCWSTR SessionName,
                                                     _In_ BOOL EnableThreatIntelProvider,
